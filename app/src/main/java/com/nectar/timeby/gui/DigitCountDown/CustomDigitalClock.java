...
//                Log.i("endTime:",""+endTime);
                ...
                distanceTime = L_endTime - L_startTime;

                if (currentTime < L_startTime){
                    distanceTime = L_endTime - L_startTime;;
                }else {
                    distanceTime = L_endTime - currentTime;
                }
                distanceTime /= 1000;
//                Log.i("distanceTime:",""+distanceTime);
    ...
    public static Spanned dealTime(long time) {
        ...
        str = Html.fromHtml(returnString.toString());
            ...
            ((Spannable) str).setSpan(new AbsoluteSizeSpan(50,true), 0, 12,
