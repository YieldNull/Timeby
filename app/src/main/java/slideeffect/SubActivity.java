...
/**
 * Created by fangdongliang on 15/7/16.
 */
...
//        map.put("parent3", list3);
    ...
    class MyAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            String key = SubActivity.this.parent.get(groupPosition);
            String info = map.get(key).get(childPosition);
            if (convertView == null) {
                LayoutInflater inflater = (LayoutInflater) SubActivity.this
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            tv.setText(SubActivity.this.parent.get(groupPosition));
            return tv;
        }
